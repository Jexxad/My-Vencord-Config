...
export default definePlugin({
    name: "VideoSpeed",
    description: "Allows you to change the speed of videos. Made by Samwich, modified by Jexxad.",
    authors: [Devs.Samwich, Devs.Jexxad],
    settings,
    patches: [
        {
            find: ".videoControls:",
        ...
        return <div ref={elementRef}>
            <Tooltip text={`Toggle Speed (${speed})`}>
                {tooltipProps => (
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="19px" height="19px" viewBox="0 0 448 512">
                            <path
                                fill={speed === 2 ? "yellow" : "currentColor"}
                                d={speedPaths[speed]}
                            ></path>
                        </svg>
                    </div>
